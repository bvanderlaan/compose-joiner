...
module.exports = {
  ...
  removeProperty(compose, serviceName, unwantedProperty) {
    const newCompose = Object.assign({}, compose);
    const service = Object.prototype.hasOwnProperty.call(compose, 'services') ?
      newCompose.services[serviceName] :
      newCompose[serviceName];

    if (service) {
      delete service[unwantedProperty];
    }
